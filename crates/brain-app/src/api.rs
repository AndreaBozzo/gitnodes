...
pub fn register_server_functions() {
    // This function exists solely to be called from main.rs.
    // It forces the linker to include this module, which ensures that
    // the automatic `inventory::submit!` calls generated by `#[server]` are not stripped.
}
