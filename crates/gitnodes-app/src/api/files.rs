...
fn extract_cover(
    ...
    file_path: &str,
    cfg: &gitnodes_domain::TargetConfig,
            ...
            match result.mode.clone() {
                ...
                WriteMode::PullRequest => {
                    ...
                    let posture = match payload.write_intent {
                        gitnodes_domain::WriteIntent::ProposeViaPr => "explicit",
                        gitnodes_domain::WriteIntent::Direct => "fallback",
                    };
                    crate::server::audit::log(
                        "propose_write",
                        Some(&user),
...
mod merge_frontmatter_tests {
    ...
    fn base_payload(node_type: String) -> BrainFilePayload {
        BrainFilePayload {
            ...
            write_intent: gitnodes_domain::WriteIntent::Direct,
        }
    }
    ...
    fn custom_type_respects_spec_title_and_date_fields() {
        use gitnodes_domain::NodeTypeSpec;
    ...
    fn work_item_create_injects_brain_id_once() {
        use gitnodes_domain::{NodeTypeSpec, WorkItemKind};
