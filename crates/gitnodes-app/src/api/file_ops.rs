...
#[cfg(feature = "ssr")]
use gitnodes_domain::{BrainError, ConflictKind};
...
async fn prepare_rename_transaction(
    ...
    user: &str,
    author_email: &str,
) -> Result<(gitnodes_storage::GitTransaction, Vec<String>), BrainError> {
    ...
    let transaction = gitnodes_storage::GitTransaction::new(message, user, author_email)
...
async fn collect_repo_md_paths(
    ...
    use gitnodes_graph::is_included_md;
